...
# 
# The reindeer is holding a book titled "Lava Island Hiking Guide". However, when you open the book, you discover that most of it
# seems to have been scorched by lava! As you're about to ask how you can help, the reindeer brings you a blank topographic map
...
# gradual, uphill slope. For all practical purposes, this means that a hiking trail is any path that starts at height 0, ends
# at height 9, and always increases by a height of exactly 1 at each step. Hiking trails never include diagonal steps - only
...
# 
# A trailhead is any position that starts one or more hiking trails - here, these positions will always have height 0. Assembling
# more fragments of pages, you establish that a trailhead's score is the number of 9-height positions reachable from that 
# trailhead via a hiking trail. In the above example, the single trailhead in the top left corner has a score of 1 because it can
...
# 
# This trailhead has a score of 4 because every 9 is reachable via a hiking trail except the one immediately to the left of
# the trailhead:
#     ..90..9
#     ...1.98
#     ...2..7
...
#     987....
# 
# This topographic map contains two trailheads; the trailhead at the top has a score of 1, while the trailhead at the bottom
# has a score of 2:
#     10..9..
#     2...8..
#     3...7..
...
# 
# The reindeer gleefully carries over a protractor and adds it to the pile. What is the sum of the scores of all trailheads
