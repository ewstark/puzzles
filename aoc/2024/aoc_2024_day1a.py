...
if __name__ == "__main__":
    ...
    l1 = sorted(puzzle_data[0])
    l2 = sorted(puzzle_data[1])
    running_delta = 0
    for n in range(len(l1)):
        delta = l2[n] - l1[n] if l2[n] > l1[n] else l1[n] - l2[n]
        running_delta += delta
        if verbose: print(l1[n], l2[n], delta, running_delta)
    print(f"Total = {running_delta}")

# submitted answer: 1830467 = correct
